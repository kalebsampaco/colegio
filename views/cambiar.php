		...
		<fieldset>
			<legend>Cambios de Contacto</legend>
				...
				<div class="item  i-b  v-middle  ph12  sm12  md12  lg-center>
					...
					<input type="text" id="nombres" class="cambio" name="nombres" placeholder="Escribe los nombre" title="nombres" value="'); echo $registro['nombres']; printf('" required />
				</div>
				<div class="item  i-b  v-middle  ph12  sm12  md12  lg-center>
					<label for="apellidos">Apellidos: </label>
					<input type="text" id="apellidos" class="cambio" name="apellidos" placeholder="Escribe los apellidos" title="apellidos" value="'); echo $registro['apellidos']; printf('" required />
				</div>');
				...
				<div class="item  i-b  v-middle  ph12  sm12  md12  lg-center>
					...
					<input type="text" id="acudiente" class="cambio" name="acudiente" placeholder="Escribe el acudiente" title="acudiente" value="'); echo $registro['acudiente']; printf('" required />
				</div>
				<div class="item  i-b  v-middle  ph12  sm12  md12  lg-center>
					<label for="direccion">Dirección: </label>
					<input type="text" id="direccion" class="cambio" name="direccion" placeholder="Escribe la dirección" title="direccion" value="'); echo $registro['direccion']; printf('" required />
				</div>
				<div class="item  i-b  v-middle  ph12  sm12  md12  lg-center>
					<label for="estudios">Estudios: </label><br>
					<textarea id="estudios" class="cambio" name="estudios" cols="50" rows="5" placeholder="Estudios realizados" title="estudios">'); echo $registro['estudios']; printf('</textarea>
				</div>
				<div class="item  i-b  v-middle  ph12  sm12  md12  lg-center>
					<label for="experiencia">Experiencia: </label><br>
					<textarea id="experiencia" class="cambio" name="experiencia" cols="50" rows="5" placeholder="Experiencia" title="experiencia">'); echo $registro['experiencia']; printf('</textarea>
				</div>
				<div class="item  i-b  v-middle  ph12  sm12  md12  lg-center>
					<label for="referencias">Referencias: </label><br>
					<textarea id="referencias" class="cambio" name="referencias" cols="50" rows="5" placeholder="referencias" title="referencias">'); echo $registro['referencias']; printf('</textarea>
				</div>

				<div div class="item  i-b  v-middle  ph12  sm12  md12  lg-center>
					<label for="nacimiento">Fecha de nacimiento: </label>
					<input type="date" id="nacimiento" class="cambio" name="nacimiento" title="fecha nacimiento" value="'); echo $registro['nacimiento']; printf('" required />
				</div>

				<div class="item  i-b  v-middle  ph12  sm12  md12  lg-center>
					<label for="m">Sexo: </label>
					<input type="radio" id="m" name="sexo" title="tipo de sexo" value="M"'); echo $sexM; printf(' required />&nbsp;<label for="m">Masculino</label>
					&nbsp;&nbsp;&nbsp;
					<input type="radio" id="f" name="sexo" title="tipo de sexo" value="F" '); echo $sexF; printf('required />&nbsp;<label for="f">Femenino</label>
				</div>');
				...
				printf('<div class="item  i-b  v-middle  ph12  sm12  md12 lg-center">
					...
					<input type="date" id="fecha_ingreso" class="cambio" name="fecha_ingreso" title="fecha de ingreso" value="'); echo $registro['fecha_ingreso']; printf('" required />
				</div>');
				...
				printf('<div class="item  i-b  v-middle  ph12  sm12  md12 lg-center">
					<label for="pass">Ingresa el Password: </label>
					<input type="password" id="pass"name="pass" placeholder="password" value="" required>
				...
				<div>
					<input type="submit" id="cambio-alta" class="button edit cambio" name="cambio_btn" value="Editar" />
