...
function subir_imagen($tipo,$imagen,$documento)
{
	...
	if(strstr($tipo,"image"))
	{
		...
		if($ancho_img>$ancho_img_deseado)
		{
			...
			switch($extension)
			{
				case ".jpg":
					...
					$nombre_img_ext = "./public/img/fotos/".$documento.$extension;
					$nombre_img = "./public/img/fotos/".$documento;
		...
		else
		{
            ...
            $destino="./public/img/fotos/".$documento.$extension;
